...
public class MethodPractice {
    public static void main(String[] args) {
        ...
        player1.updatesStatus(0.315, 18);
        System.out.println(player1.battingAverage); // 0.315
        System.out.println(player1.homeRuns); // 18

        System.out.println(BaseballPlayer.evaluateHomeRun(21)); // 홈런상 후보에 등록됩니다.
        System.out.println(BaseballPlayer.evaluateHomeRun(19)); // 홈런상 후보에 들어갈 수 없습니다.
