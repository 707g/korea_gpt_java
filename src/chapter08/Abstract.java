...
abstract class Tiger {
    abstract void strip(); // 줄무늬
}

// abstract class Liger extends Lion extends Tiger{ - 다중 상속 불가 !
//    void mane() {
//
//    }
//
//    void strip() { - 해당 메서드를 상속 받을 수 없음
//
//    }
//}
...
class Dog extends Animal{
    ...
    @Override
    void eat() {
        System.out.println("강아지를 개껌을 먹습니다.");
    }
}
