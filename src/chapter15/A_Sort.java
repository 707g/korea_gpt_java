...
public class A_Sort {
    public static void main(String[] args) {
        ...
        // == 내림차순 ==
        List<Integer> reverseSorted = listNumbers.stream()
                .sorted((a, b) -> b - a) // 내림차순
                .collect(Collectors.toList());
        ...
        List<String> sortedCharacterNames = CharacterNames.stream()
                .sorted((n1, n2) -> n1.length() - n2.length()) // 오름차순
                .collect(Collectors.toList());

        System.out.println(sortedCharacterNames); // [Tom, Jerry, Ruffy, Pororo]
