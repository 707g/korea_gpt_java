...
//         at chapter09.Exception01.main(Exception01.java:54)
        // System.out.println(division); - 런타임 예외
        ...
        try {
            ...
            // try 블록 내에서 발생하는 예외를 () 소괄호 내에서 매개변수를 전달받아 {} 실행문에서 처리
            System.out.println(e.getMessage()); // / by zero
            System.out.println("0으로 나올 수 없습니다."); // 0으로 나올 수 없습니다.
        }
        ...
        // == throw 키워드 ==
        // : 프로그램 실행 중에 특정 조건에서 예외를 직접 발생시킬 떄 사용
        // > 주로 조건문과 함께 사용
