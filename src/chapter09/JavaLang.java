...
public class JavaLang{
    public static void main(String[] args) {
        ...
        System.out.println(Math.abs(-10)); // 절대값 반환: .abs(데이터) | (10)
        System.out.println(Math.max(100, 200)); // 최대값 반환: .max(데이터1, 데이터2) | (200)
        System.out.println(Math.min(100, 200)); // 최소값 반환: .min(데이터1, 데이터2) | (100)
        System.out.println(Math.sqrt(16)); // square root | (4.0)
        System.out.println(Math.pow(2, 3)); // 제곱 값 반환: .pow(a, b) == a의 b제곱 | (8.0)
        System.out.println(Math.random());
        // 무작위 난수를 생성: .random() - 0.0 이상 1.0미만의 난수를 생성
