...
public class JavaTime {
    public static void main(String[] args) {
        ...
        System.out.println(now); // 12:16:42.236869800

        LocalTime specificTime = LocalTime.of(14, 30);
        System.out.println(specificTime); // 14:30

        LocalTime thirtyThreeMinutesLater = now.plusMinutes(33);
        System.out.println(thirtyThreeMinutesLater); // 12:51:19.797777700

        LocalTime oneHourAgo = now.minusHours(1);
        System.out.println(oneHourAgo); // 11:19:20.050259500
        ...
        System.out.println(nowDateTime); // 2024-12-05T12:24:13.141585800
        System.out.println(nowDateTime.toLocalDate()); // 2024-12-05
        System.out.println(nowDateTime.toLocalTime()); // 12:24:13.141585800

        // cf) 날짜와 시간 포맷팅(formatting)
        LocalDateTime example = LocalDateTime.now();
        System.out.println(example); // 2024-12-05T12:28:13.406945100
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yy-MM-dd HH:mm:ss");
        System.out.println(example.format(formatter)); // 24-12-05 12:28:13
