...
public class UserService {
    ...
    public static void main(String[] args) {
        UserSignUpRequestDto dto1 = new UserSignUpRequestDto(
                "123", "1234", "1234",
                "이승아", "qwe", "01011111111", "개구리"
        );

        User user1 = signUp(dto1);
        System.out.println(user1.getSignUpDate()); // Thu Dec 12 12:06:27 KST 2024

        List<User> userList = null;
        List<UserSignUpRequestDto> dtos = new ArrayList<>();
        dtos.add(new UserSignUpRequestDto("123", "1234", "1234",
                "이승아1", "qwe", "01011111111", "개구리"));
        dtos.add(new UserSignUpRequestDto("123", "1234", "1234",
                "이승아2", "qwe", "01011111111", "개구리"));
        dtos.add(new UserSignUpRequestDto("123", "1234", "1234",
                "이승아3", "qwe", "01011111111", "개구리"));
