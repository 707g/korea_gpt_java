...
//                .map(student -> student.getName())
        ...
        System.out.println(StudentsNames); // [이승아, 이도경, 이지훈, 이지희]
        ...
        List<StudentClass> sortedStudents = studentClasses.stream()
                ...
                // .sorted(Comparator.comparingDouble(StudentClass::getGrade).reversed()) cf) 내림차순
                .collect(Collectors.toList());

        System.out.println("점수순으로 정렬된 학생들:");
