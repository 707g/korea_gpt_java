...
class EventManagement {
    ...
    void addToWaitingQue(String name) {
...
public class C_ListPractice {
    public static void main(String[] args) {
        ...
        eventManagement.addToWaitingQue("윤대휘");
        eventManagement.addToWaitingQue("김소빈");
        eventManagement.addToWaitingQue("정규민");
        eventManagement.addToWaitingQue("박성욱");
