...
public class A_Wrapper {
    public static void main(String[] args) {
        ...
        System.out.println(parseInt);// 250

        // - valueOf(int i): int 값을 가진 Integer 객체를 반환
        Integer anothorInteger = Integer.valueOf(500);
        System.out.println(anothorInteger); // 500

        // - compareTo(Integer anotherInteger): 두 Integer 객체를 비교하여 같으면 0
        //      , 호출 객체가 더 크면 양수, 더 작으면 음수를 반환
        int result = myInteger.compareTo(anothorInteger);
